...
Description
----
The "orders" component has been developed for the municipality of Utrecht and has the purpose of processing orders. This component often goes hand in hand with the components payment and products and services, but this is not always necessary.
...
- If you haven't have setup the component locally read the Installation part for setting up your local environment.
